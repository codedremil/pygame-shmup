...
def show_game_over_screen():
    ...
    draw_text(screen, "Appuyez sur une touche pour commencer", 18, 
              WIDTH / 2, HEIGHT * 3 / 4)
    # ex15: affiche le score si nécessaire
    if score is not None:
        draw_text(screen, f"Score: {score}", 35, WIDTH / 2, HEIGHT / 3 + 20)
...
# Quand on affiche l'écran de démarrage, ce code est déplacé dans la boucle !
...
while running:
    ...
    for hit in hits:
        ...
        if player.shield <= 0:
            ...
            # TODO: produire le bruit d'une petite explosion
            pass
